...
@pytest.fixture
def bim_string():
    return """1	rs11252127	0	1	A	C
1	rs12255619	0	4	G	T
2	rs10751931	0	3	C	T"""


@pytest.fixture
def expected_result():
    return pd.read_table(StringIO("""1	rs11252127	0	1	A	C   A   T
1	rs12255619	0	4	G	T   T   A
2	rs10751931	0	3	C	T   C   G"""),
                        sep=r"\s+", header=None,
